...
def app_target_common():
    return [
        ...
        'INFOPLIST_KEY_CFBundleDisplayName = "Record Seconds";',
        'INFOPLIST_KEY_NSCameraUsageDescription = "Record Seconds uses the camera to film your one-second clips.";',
        'INFOPLIST_KEY_NSMicrophoneUsageDescription = "Record Seconds uses the microphone to record sound with your clips.";',
        'INFOPLIST_KEY_NSPhotoLibraryAddUsageDescription = "Record Seconds saves your exported movies to Photos.";',
